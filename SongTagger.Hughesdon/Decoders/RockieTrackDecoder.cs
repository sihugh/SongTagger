...
namespace SongTagger.Hughesdon.Decoders
{
    ...
    {
        readonly string[] _voiceParts = "Full Choir With Solo,Full Choir,Upper Alto,Lower Alto,Alto,Upper Bass,Lower Bass,Medium,Bass,Upper Soprano,Lower Soprano,Soprano,Upper Sop,Lower Sop,Sop".Split(',');
